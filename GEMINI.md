...
_For the original planning conversation, see the backend's [pitchwiz-plan.md](file:///c:/Users/timsh/github/pitchwiz-backend/pitchwiz-plan.md)._
_For the backend configuration and database model details, see the backend's [GEMINI.md](file:///c:/Users/timsh/github/pitchwiz-backend/GEMINI.md)._
