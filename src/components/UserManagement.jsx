...
export default function UserManagement() {
  ...
  if (loading)
    return <div className="p-8 text-slate-400">Loading user management...</div>;
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Manage club personnel, roles, permissions, and account access.
          </p>
        </div>
        <button
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {u.roles && u.roles.length > 0 ? (
                        u.roles.map((r, i) => (
                          <span
                            key={i}
                            className="px-2.5 py-0.5 rounded-lg text-xxs font-extrabold font-display uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"
                          >
                            {r.replace("_", " ")}
                          </span>
                        ))
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      {u.force_password_reset && (
                        <span
                          className="flex items-center space-x-1 text-orange-400 text-xs font-semibold px-2 py-0.5 bg-orange-400/10 border border-orange-400/20 rounded-md"
              ...
              {!editingUser && (
                <div>
                  ...
                  <p className="text-xxs text-slate-500 mt-1">
                    Min 10 chars, 1 uppercase, 1 lowercase, 1 digit, 1 special
                    symbol.
                  </p>
                </div>
              )}
