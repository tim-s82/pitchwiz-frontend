...
export default function TeamsManager({ teams, pitchLengths, onTeamsChanged }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {toast && (
        <div
          className={`flex items-center gap-2.5 px-4 py-3 rounded-xl text-sm font-medium border transition-all animate-in fade-in slide-in-from-top-2 duration-300 ${
            toast.type === "error"
        ...
        {teams.length === 0 ? (
          ...
          <>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-800/60">
                      <th className="text-left text-[11px] font-semibold uppercase tracking-wider text-slate-500 py-2.5 px-4">
                        Name
                      </th>
                      <th className="text-left text-[11px] font-semibold uppercase tracking-wider text-slate-500 py-2.5 px-4">
                        Pitch Length
                      ...
                      <th className="text-right text-[11px] font-semibold uppercase tracking-wider text-slate-500 py-2.5 px-4">
                        Actions
                      </th>
                    </tr>
                  </thead>
                  <tbody>{clubTeams.map(renderTeamRow)}</tbody>
                </table>
              </div>
            )}
            ...
            {externalTeams.length > 0 && (
              <div
                className={
                  clubTeams.length > 0 ? "border-t border-slate-800/40" : ""
                }
              >
                <div className="px-4 py-2.5 bg-slate-900/50 border-b border-slate-800/60">
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-slate-500 flex items-center gap-1.5">
                ...
                <table className="w-full">
                  ...
                  <tbody>{externalTeams.map(renderTeamRow)}</tbody>
                </table>
              </div>
            )}
          </>
